...
[dynamodb]
aws cloudformation create-stack --stack-name qiitank-dynamodb --template-body file://dynamodb.yml
aws cloudformation update-stack --stack-name qiitank-dynamodb --template-body file://dynamodb.yml
