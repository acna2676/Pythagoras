...
[dynamodb]
aws cloudformation create-stack --stack-name pythagoras-dynamodb --template-body file://dynamodb.yml
aws cloudformation update-stack --stack-name pythagoras-dynamodb --template-body file://dynamodb.yml
